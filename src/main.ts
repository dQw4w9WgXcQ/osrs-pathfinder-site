...
map.fitBounds(L.latLngBounds(pointToLatLng({...INITIAL_START_POSITION, x: INITIAL_START_POSITION.x - 200}), pointToLatLng({...INITIAL_FINISH_POSITION, x : INITIAL_FINISH_POSITION.x + 200})))
